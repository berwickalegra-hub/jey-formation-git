...
//
// Flow: signup → "check your email" → /verify-email (with the 8-char code
// from the email) → cookies issued + dashboard. The signup endpoint is
// enumeration-resistant: it returns the same response whether the email
// is new or already in use, so we always show "check your email" here.
'use client';
